                    ...
                    <div class="card-body">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="jumlah" value="{{ old('jumlah') }}" placeholder="Stock Bunga">
                                <!-- error message untuk 'nama' -->
                                @error('jumlah')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="harga" value="{{ old('harga') }}" placeholder="Harga">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="image" class="form-control-file @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" placeholder="Gambar" accept="image/*">
